...
python (Join-Path $PSScriptRoot 'inject-structured-data.py')
python (Join-Path $PSScriptRoot 'cleanup-wix-leftovers.py')
...
python (Join-Path $PSScriptRoot 'fix-help-card-images.py')
python (Join-Path $PSScriptRoot 'create-local-assets.py')
python (Join-Path $PSScriptRoot 'fix-assistive-devices-image.py')
python (Join-Path $PSScriptRoot 'fix-image-priority.py')
python (Join-Path $PSScriptRoot 'localize-fonts.py')
python (Join-Path $PSScriptRoot 'fix-booking-redirects.py')
python (Join-Path $PSScriptRoot 'inject-lcp-preload.py')
python (Join-Path $PSScriptRoot 'inject-page-hero-preload.py')
